# gravitace.py
# GPU-akcelerovaný gravitacní simulátor pixelů pomocí pygame + numba
...
pygame.display.set_caption("GPU Gravitační pixely")
...
while running:
    ...
    pygame.draw.circle(screen, YELLOW, (int(SUN_X), int(SUN_Y)), 10)
